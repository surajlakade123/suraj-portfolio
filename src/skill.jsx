...
function Feature() {
 ...
 <h1 className='  font-bold text-3xl lg:text-4x text-blue-500 tracking-tight  '> --- Skill ---</h1>
         <div  id="slide-in" className='h-full w-[70%]  grid grid-cols-1 md:grid-rows-1 gap-20 items-center   mt-12.5 sm:mt-25 sm:ms-60'>
           <div className='border-2 border-white border-solid rounded-xl h-auto  sm:h-auto w-full sm:w-[90%] flex justify-center  bg-white text-black  flex-col'>
 ...
 <h1 className='text-3xl lg:text-4xl  font-bold text-blue-500 tracking-tight  '> --- Project ---</h1>
         <div  id="slide-in" className='h-full w-[70%]  grid grid-cols-1 md:grid-rows-4 gap-20 items-center   mt-12.5 sm:mt-25  sm:ms-60'>
           <div className='border-2 border-white border-solid rounded-xl h-auto  sm:auto w-full sm:w-[90%] flex justify-center  bg-white text-black  flex-col'>
